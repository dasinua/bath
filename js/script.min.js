...
o.trigger("activate.bs.scrollspy")},e.prototype.clear=function(){t(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var o=t.fn.scrollspy;t.fn.scrollspy=i,t.fn.scrollspy.Constructor=e,t.fn.scrollspy.noConflict=function(){return t.fn.scrollspy=o,this},t(window).on("load.bs.scrollspy.data-api",function(){t('[data-spy="scroll"]').each(function(){var e=t(this);i.call(e,e.data())})})}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),n=o.data("bs.tab");n||o.data("bs.tab",n=new i(this)),"string"==typeof e&&n[e]()})}var i=function(e){this.element=t(e)};i.VERSION="3.3.6",i.TRANSITION_DURATION=150,i.prototype.show=function(){var e=this.element,i=e.closest("ul:not(.dropdown-menu)"),o=e.data("target");if(o||(o=e.attr("href"),o=o&&o.replace(/.*(?=#[^\s]*$)/,"")),!e.parent("li").hasClass("active")){var n=i.find(".active:last a"),s=t.Event("hide.bs.tab",{relatedTarget:e[0]}),a=t.Event("show.bs.tab",{relatedTarget:n[0]});if(n.trigger(s),e.trigger(a),!a.isDefaultPrevented()&&!s.isDefaultPrevented()){var r=t(o);this.activate(e.closest("li"),i),this.activate(r,r.parent(),function(){n.trigger({type:"hidden.bs.tab",relatedTarget:e[0]}),e.trigger({type:"shown.bs.tab",relatedTarget:n[0]})})}}},i.prototype.activate=function(e,o,n){function s(){a.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),e.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),r?(e[0].offsetWidth,e.addClass("in")):e.removeClass("fade"),e.parent(".dropdown-menu").length&&e.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),n&&n()}var a=o.find("> .active"),r=n&&t.support.transition&&(a.length&&a.hasClass("fade")||!!o.find("> .fade").length);a.length&&r?a.one("bsTransitionEnd",s).emulateTransitionEnd(i.TRANSITION_DURATION):s(),a.removeClass("in")};var o=t.fn.tab;t.fn.tab=e,t.fn.tab.Constructor=i,t.fn.tab.noConflict=function(){return t.fn.tab=o,this};var n=function(i){i.preventDefault(),e.call(t(this),"show")};t(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',n).on("click.bs.tab.data-api",'[data-toggle="pill"]',n)}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),n=o.data("bs.affix"),s="object"==typeof e&&e;n||o.data("bs.affix",n=new i(this,s)),"string"==typeof e&&n[e]()})}var i=function(e,o){this.options=t.extend({},i.DEFAULTS,o),this.$target=t(this.options.target).on("scroll.bs.affix.data-api",t.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",t.proxy(this.checkPositionWithEventLoop,this)),this.$element=t(e),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};i.VERSION="3.3.6",i.RESET="affix affix-top affix-bottom",i.DEFAULTS={offset:0,target:window},i.prototype.getState=function(t,e,i,o){var n=this.$target.scrollTop(),s=this.$element.offset(),a=this.$target.height();if(null!=i&&"top"==this.affixed)return n<i&&"top";if("bottom"==this.affixed)return null!=i?!(n+this.unpin<=s.top)&&"bottom":!(n+a<=t-o)&&"bottom";var r=null==this.affixed,l=r?n:s.top,h=r?a:e;return null!=i&&n<=i?"top":null!=o&&l+h>=t-o&&"bottom"},i.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(i.RESET).addClass("affix");var t=this.$target.scrollTop(),e=this.$element.offset();return this.pinnedOffset=e.top-t},i.prototype.checkPositionWithEventLoop=function(){setTimeout(t.proxy(this.checkPosition,this),1)},i.prototype.checkPosition=function(){if(this.$element.is(":visible")){var e=this.$element.height(),o=this.options.offset,n=o.top,s=o.bottom,a=Math.max(t(document).height(),t(document.body).height());"object"!=typeof o&&(s=n=o),"function"==typeof n&&(n=o.top(this.$element)),"function"==typeof s&&(s=o.bottom(this.$element));var r=this.getState(a,e,n,s);if(this.affixed!=r){null!=this.unpin&&this.$element.css("top","");var l="affix"+(r?"-"+r:""),h=t.Event(l+".bs.affix");if(this.$element.trigger(h),h.isDefaultPrevented())return;this.affixed=r,this.unpin="bottom"==r?this.getPinnedOffset():null,this.$element.removeClass(i.RESET).addClass(l).trigger(l.replace("affix","affixed")+".bs.affix")}"bottom"==r&&this.$element.offset({top:a-e-s})}};var o=t.fn.affix;t.fn.affix=e,t.fn.affix.Constructor=i,t.fn.affix.noConflict=function(){return t.fn.affix=o,this},t(window).on("load",function(){t('[data-spy="affix"]').each(function(){var i=t(this),o=i.data();o.offset=o.offset||{},null!=o.offsetBottom&&(o.offset.bottom=o.offsetBottom),null!=o.offsetTop&&(o.offset.top=o.offsetTop),e.call(i,o)})})}(jQuery),!function(t){"function"==typeof define&&define.amd?define(["jquery"],t):t("object"==typeof exports?require("jquery"):jQuery)}(function(t){var e,i=navigator.userAgent,o=/iphone/i.test(i),n=/chrome/i.test(i),s=/android/i.test(i);t.mask={definitions:{9:"[0-9]",a:"[A-Za-z]","*":"[A-Za-z0-9]"},autoclear:!0,dataName:"rawMaskFn",placeholder:"_"},t.fn.extend({caret:function(t,e){var i;if(0!==this.length&&!this.is(":hidden"))return"number"==typeof t?(e="number"==typeof e?e:t,this.each(function(){this.setSelectionRange?this.setSelectionRange(t,e):this.createTextRange&&(i=this.createTextRange(),i.collapse(!0),i.moveEnd("character",e),i.moveStart("character",t),i.select())})):(this[0].setSelectionRange?(t=this[0].selectionStart,e=this[0].selectionEnd):document.selection&&document.selection.createRange&&(i=document.selection.createRange(),t=0-i.duplicate().moveStart("character",-1e5),e=t+i.text.length),{begin:t,end:e})},unmask:function(){return this.trigger("unmask")},mask:function(i,a){var r,l,h,d,c,p,f,u;if(!i&&this.length>0){r=t(this[0]);var g=r.data(t.mask.dataName);return g?g():void 0}return a=t.extend({autoclear:t.mask.autoclear,placeholder:t.mask.placeholder,completed:null},a),l=t.mask.definitions,h=[],d=f=i.length,c=null,t.each(i.split(""),function(t,e){"?"==e?(f--,d=t):l[e]?(h.push(new RegExp(l[e])),null===c&&(c=h.length-1),d>t&&(p=h.length-1)):h.push(null)}),this.trigger("unmask").each(function(){function r(){if(a.completed){for(var t=c;p>=t;t++)if(h[t]&&I[t]===g(t))return;a.completed.call(S)}}function g(t){return a.placeholder.charAt(t<a.placeholder.length?t:0)}function m(t){for(;++t<f&&!h[t];);return t}function v(t){for(;--t>=0&&!h[t];);return t}function b(t,e){var i,o;if(!(0>t)){for(i=t,o=m(e);f>i;i++)if(h[i]){if(!(f>o&&h[i].test(I[o])))break;I[i]=I[o],I[o]=g(o),o=m(o)}x(),S.caret(Math.max(c,t))}}function y(t){var e,i,o,n;for(e=t,i=g(t);f>e;e++)if(h[e]){if(o=m(e),n=I[e],I[e]=i,!(f>o&&h[o].test(n)))break;i=n}}function $(){var t=S.val(),e=S.caret();if(u&&u.length&&u.length>t.length){for(E(!0);e.begin>0&&!h[e.begin-1];)e.begin--;if(0===e.begin)for(;e.begin<c&&!h[e.begin];)e.begin++;S.caret(e.begin,e.begin)}else{for(E(!0);e.begin<f&&!h[e.begin];)e.begin++;S.caret(e.begin,e.begin)}r()}function w(){E(),S.val()!=A&&S.change()}function T(t){if(!S.prop("readonly")){var e,i,n,s=t.which||t.keyCode;u=S.val(),8===s||46===s||o&&127===s?(e=S.caret(),i=e.begin,n=e.end,n-i===0&&(i=46!==s?v(i):n=m(i-1),n=46===s?m(n):n),k(i,n),b(i,n-1),t.preventDefault()):13===s?w.call(this,t):27===s&&(S.val(A),S.caret(0,E()),t.preventDefault())}}function C(e){if(!S.prop("readonly")){var i,o,n,a=e.which||e.keyCode,l=S.caret();if(!(e.ctrlKey||e.altKey||e.metaKey||32>a)&&a&&13!==a){if(l.end-l.begin!==0&&(k(l.begin,l.end),b(l.begin,l.end-1)),i=m(l.begin-1),f>i&&(o=String.fromCharCode(a),h[i].test(o))){if(y(i),I[i]=o,x(),n=m(i),s){var d=function(){t.proxy(t.fn.caret,S,n)()};setTimeout(d,0)}else S.caret(n);l.begin<=p&&r()}e.preventDefault()}}}function k(t,e){var i;for(i=t;e>i&&f>i;i++)h[i]&&(I[i]=g(i))}function x(){S.val(I.join(""))}function E(t){var e,i,o,n=S.val(),s=-1;for(e=0,o=0;f>e;e++)if(h[e]){for(I[e]=g(e);o++<n.length;)if(i=n.charAt(o-1),h[e].test(i)){I[e]=i,s=e;break}if(o>n.length){k(e+1,f);break}}else I[e]===n.charAt(o)&&o++,d>e&&(s=e);return t?x():d>s+1?a.autoclear||I.join("")===D?(S.val()&&S.val(""),k(0,f)):x():(x(),S.val(S.val().substring(0,s+1))),d?e:c}var S=t(this),I=t.map(i.split(""),function(t,e){return"?"!=t?l[t]?g(e):t:void 0}),D=I.join(""),A=S.val();S.data(t.mask.dataName,function(){return t.map(I,function(t,e){return h[e]&&t!=g(e)?t:null}).join("")}),S.one("unmask",function(){S.off(".mask").removeData(t.mask.dataName)}).on("focus.mask",function(){if(!S.prop("readonly")){clearTimeout(e);var t;A=S.val(),t=E(),e=setTimeout(function(){S.get(0)===document.activeElement&&(x(),t==i.replace("?","").length?S.caret(0,t):S.caret(t))},10)}}).on("blur.mask",w).on("keydown.mask",T).on("keypress.mask",C).on("input.mask paste.mask",function(){S.prop("readonly")||setTimeout(function(){var t=E(!0);S.caret(t),r()},0)}),n&&s&&S.off("input.mask").on("input.mask",$),E()})}})}),$(document).ready(function(){function t(){var t;t=new ymaps.Map("map",{center:[56.818375,60.575412],zoom:16,controls:[]}),t.behaviors.disable("scrollZoom"),t.controls.add("zoomControl",{position:{top:15,left:15}});var e=new ymaps.Placemark([56.818375,60.575412],{},{iconLayout:"default#image",iconImageHref:"./img/metka.png",iconImageSize:[60,88],iconImageOffset:[-30,-90]});t.geoObjects.add(e)}$(".maskedinput").mask("+7(999) 999-99-99"),$("#callMaster, #discount, #learnMore, #receivePresen").submit(function(){return $.ajax({type:"POST",url:"mail.php",data:$(this).serialize()}).done(function(){$(this).find("input").val(""),$("#thanks").modal("show"),$("#callMaster, #discount, #learnMore, #receivePresen").trigger("reset")}),!1}),$("#myModal11, #myModal22, #myModal33, #myModal44, #myModal55").submit(function(){return $.ajax({type:"POST",url:"mail.php",data:$(this).serialize()}).done(function(){$(this).find("input").val(""),$("#myModal1, #myModal2, #myModal3, #myModal4, #myModal5").modal("hide"),$("#thanks").modal("show"),$("#myModal11, #myModal22, #myModal33, #myModal44, #myModal55").trigger("reset")}),!1}),$("#menu").on("click","a",function(t){t.preventDefault();var e=$(this).attr("href"),i=$(e).offset().top;$("body,html").animate({scrollTop:i},1500)}),ymaps.ready(t)});